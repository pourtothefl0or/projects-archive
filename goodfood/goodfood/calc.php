<!-- calc -->
<section class="modal modal-action flex-col" data-target="calc">
    ...
    <h2 class="modal-action__title">Калькулятор суточной нормы калорий</h2>
    <form class="modal-action__functions flex-col">
        <!-- ui-input -->
        <label class="ui-input_inner">
            <select class="ui-input__item" id="sex_calc" required>
                <option value="" hidden></option>
                <option value="1">Мужской</option>
                <option value="2">Женский</option>
            </select>
            <span class="ui-input__name">Род</span>
        </label>
        <!-- //ui-input -->

        <!-- ui-input -->
        <label class="ui-input_inner">
            <input type="number" id="height_calc" class="ui-input__item" min="0" required>
            <span class="ui-input__name">Рост</span>
        </label>
        <!-- //ui-input -->

        <!-- ui-input -->
        <label class="ui-input_inner">
            <input type="number" id="weight_calc" class="ui-input__item" min="0" required>
            <span class="ui-input__name">Вес</span>
        </label>
        <!-- //ui-input -->

        <!-- ui-input -->
        <label class="ui-input_inner">
            <input type="number" id="age_calc" class="ui-input__item" min="0" required>
            <span class="ui-input__name">Возраст</span>
        </label>
        <!-- //ui-input -->

        <!-- ui-input -->
        <label class="ui-input_inner">
            <select class="ui-input__item" id="load_calc" required>
                <option value="" hidden></option>
                <option value="1">Минимальная</option>
                <option value="2">Низкая</option>
                <option value="3">Средняя</option>
                <option value="4">Высокая</option>
                <option value="5">Очень высокая</option>
            </select>
            <span class="ui-input__name">Активность</span>
        </label>
        <!-- //ui-input -->
        <button class="ui-button" id="button_calc">Рассчитать</button>
    </form>
    <p class="form-error" id="error_calc"></p>
</section>
<!-- //calc -->