...
$products_query = "SELECT * FROM `products` $get_category $get_sorting $order";
?>
                ...
                <aside class="filters">
                    <form>
                        ...
                        <div class="filters__button">
                            ...
                            <button class="ui-button flex-c-c" id="button_reset">
                        ...
                        <a href="product.php?id=<?= $products_item['products_id']; ?>" class="card-link">
                            <article class="card">
                                ...
                                <ul class="card-list">
                                    ...
                                    <li class="card-list__item">
                                        <p class="card__calories">Калорийность: <?= $products_item['products_property-1']; ?>кк.</p>
                                    </li>
                                </ul>
                            </article>
                        </a>
