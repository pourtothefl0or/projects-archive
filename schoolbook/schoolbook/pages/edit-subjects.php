...
$edits = mysqli_query($connect, "SELECT * FROM `subjects` WHERE `id` = '$id'");
            ...
            <div class="container">
                ...
                <div class="admin-edit">
                    <div class="admin-content pd">
                        <h2 class="title middle-title">Редактировать предмет "<?php echo $edit['subject']; ?>"</h2>
                        <form action="../functions/f_edit-subjects.php?id=<?php echo $edit['id']; ?>" method="POST">
                            <div class="admin-content">
                                ...
                                <input type="text" name="subject" class="info-input" value="<?php echo $edit['subject']; ?>">
