...
$books = mysqli_query($connect,"SELECT * FROM `books` WHERE `subject` = '$id'");
$names = mysqli_query($connect,"SELECT * FROM `books` WHERE `subject` = '$id'");
?>
...
<head>
    ...
    <title>SCHOOLBOOK - ПРЕДМЕТЫ</title>
...
<?php require ('../components/header.php'); ?>
    <main>
        <section class="books pd">
            ...
            <h2 class="title middle-title"><?php echo $name['subject']; ?></h2>
            <?php } ?>
